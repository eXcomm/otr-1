...
namespace OffTheRecord.Tests
{
    ...
    public class EndianTest
    {
        ...
        public void ByteArrayToBigInteger()
        {
            ...
            BigInteger actual1 = BigInteger.Parse(x, System.Globalization.NumberStyles.HexNumber);

            Assert.AreEqual<string>(expected, actual1.ToString());

            string actual2 = actual1.ToString("X");

            Assert.AreEqual<string>(x, actual2);
        }
        #endregion
    }
}
