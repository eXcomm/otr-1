...
namespace System.ComponentModel.Composition
{
    ...
    public static class CompositionInitializer
    {
        ...
        public static void SatisfyImports(object attributedPart)
        {
            ...
            {
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, ExceptionStrings.ArgumentException_TypeHasExports, attributedPart.GetType().FullName), "attributedPart");
            }
